...
import com.nashtech.icecream.service.dto.PasswordChangeDTO;
import com.nashtech.icecream.service.dto.UserDTO;
import com.nashtech.icecream.web.rest.errors.ExceptionTranslator;
import com.nashtech.icecream.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResourceIT {
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.CUSTOMER));
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.CUSTOMER));
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.CUSTOMER));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.CUSTOMER).get());
    }
