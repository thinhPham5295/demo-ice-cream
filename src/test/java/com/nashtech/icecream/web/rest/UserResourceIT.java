...
import com.nashtech.icecream.service.mapper.UserMapper;
import com.nashtech.icecream.web.rest.errors.ExceptionTranslator;
import com.nashtech.icecream.web.rest.vm.ManagedUserVM;
...
public class UserResourceIT {
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
            ...
            .andExpect(jsonPath("$").value(hasItems(AuthoritiesConstants.CUSTOMER, AuthoritiesConstants.ADMIN)));
    }
    ...
    public void testUserDTOtoUser() {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.CUSTOMER));
        ...
        assertThat(user.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.CUSTOMER);
    }
    ...
    public void testUserToUserDTO() {
        ...
        authority.setName(AuthoritiesConstants.CUSTOMER);
        ...
        assertThat(userDTO.getAuthorities()).containsExactly(AuthoritiesConstants.CUSTOMER);
    ...
    public void testAuthorityEquals() {
        ...
        authorityA.setName(AuthoritiesConstants.CUSTOMER);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityB.setName(AuthoritiesConstants.CUSTOMER);
        assertThat(authorityA).isEqualTo(authorityB);
